			...
			<div class="row">
				<div class="col">
					<div class="card-box-c foo">
						...
						<div class="card-body-c">
							<h2 class="title-card">Notice</h2>
							<p class="content-c">사이트 이용 및 관련하여<br>공지사항을 안내드립니다.</p>
						</div>
				...
				<div class="col">
					<div class="card-box-c foo">
						...
						<div class="card-footer-c">
							<a href="interest?sign=mvbiz" class="link-c link-icon">Read more <span
								class="bi bi-chevron-right"></span>
							</a>
						</div>
					</div>
				...
				<div class="col">
					<div class="card-box-c foo">
						...
						<div class="card-footer-c">
							<a href="interest?sign=mvenv" class="link-c link-icon"> Read more <span 
								class="bi bi-chevron-right"></span> 
							</a>
						</div>
					</div>
				...
				<div class="col">
					<div class="card-box-c foo">
						...
						<div class="card-footer-c">
							<a href="interest?sign=mvhospital" class="link-c link-icon">Read more <span
								class="bi bi-chevron-right"></span>
							</a>
						</div>
					</div>
				...
				<div class="col">
					<div class="card-box-c foo">
						...
						<div class="card-footer-c">
							<a href="interest?sign=mvclinic" class="link-c link-icon"> Read more <span 
								class="bi bi-chevron-right"></span> 
							</a>
						</div>
					</div>
