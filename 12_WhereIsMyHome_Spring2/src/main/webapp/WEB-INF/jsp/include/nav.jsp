...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
  <div class="container">
    ...
    <a class="navbar-brand text-brand" href="/">WhereIs<span class="color-b">MyHouse</span></a>
      ...
      <div class="navbar-collapse collapse justify-content-end mx-5" id="navbarDefault">
        <ul class="navbar-nav" id="loginLi">
         ...
         <!-- <li class="nav-item" >
            <a class="nav-link " href = "member?sign=login" id="join">로그인 / 회원가입</a>
          </li> -->

         <li class="nav-item">
            <a class="nav-link " href="/member/loginForm" id="login">로그인 / 회원가입</a>
          </li>
