		...
		<div class="form-panel one">
			...
			<div class="form-content">
				<form>
					...
					<div class="form-group">
						<%--@declare id="interest"--%>
						<label for="interest">Interest Location</label> <a
							id="userinfo-interest">${interest.sidoName}
							${interest.gugunName} ${interest.dongName}</a>
						<!-- <input type="text" id="nickname" name="nickname" required="required" placeholder="이름을 입력해주세요"/> -->
					</div>
					<div class="form-group row justify-content-end">
						<button type="button" onclick="location.href='/member/update'"
							id="joinform">수정하러 가기</button>
					</div>
